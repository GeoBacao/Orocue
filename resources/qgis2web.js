...
var map = new ol.Map({
    ...
    layers: [new ol.layer.Tile({source:new ol.source.OSM}),lyr_reasaprovechables_0,lyr_CoberturasCLC_1,lyr_Permetro_2],
    view: new ol.View({
...
map.getView().fit([-7974123.638270, 522798.547036, -7957778.367353, 535304.525046], map.getSize());
map.getView().setCenter(ol.proj.fromLonLat([-71.55521921843051, 4.743435977288724])); //TRansformación coordenadas
map.getView().setZoom(13); //Ajustar Zoom
